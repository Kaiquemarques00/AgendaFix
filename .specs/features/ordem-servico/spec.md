...
| -------------- | ----- | ----- | ------ |
| OS-01 | P1: Cadastro | Design | Pending |
| OS-02 | P1: Cadastro | Design | Pending |
| OS-03 | P1: Cadastro | Design | Pending |
| OS-04 | P1: Atualização Status | Design | Pending |
| OS-05 | P1: Atualização Status | Design | Pending |
